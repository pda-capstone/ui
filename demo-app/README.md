...
To run the fake daemon and demo together on a private bus using the new `pda-demo-app` layout:
...
If the virtual environment is already created and working, you can skip the `uv venv` step.
