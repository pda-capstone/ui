...
def create_daemon_status_panel():
    ...
    status_bar = Gtk.Button(label=get_status_bar_text(expanded=False))
    ...
    status_details = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=6)
    ...
    status_revealer.set_transition_type(Gtk.RevealerTransitionType.SLIDE_DOWN)
